...
const snapshot: PalletWorkSnapshot = {
  ...
  result: {
    ...
    remaining: [], palletCount: 2,
    requestedPalletCount: 2, loadedPalletCount: 2, unloadedPalletCount: 0,
    requestedBoxCount: 4, loadedBoxCount: 4, unloadedBoxCount: 0,
    loadedCargoWeightKg: 40, totalPackagingWeightKg: 0,
