...
function result(): OptimizedPalletPackingResult {
  ...
  return {
    ...
    placements: [placement], remaining: [], palletCount: 1,
    requestedPalletCount: 1, loadedPalletCount: 1, unloadedPalletCount: 0,
    requestedBoxCount: 1, loadedBoxCount: 1, unloadedBoxCount: 0,
