import realisticEquipmentAtlas from './assets/equipment-realistic-atlas.webp';
...
export default function EquipmentCard3D({ item }: Props) {
  ...
  return <span className="equipment-card-photo" aria-hidden="true">
    <img
      src={realisticEquipmentAtlas}
      alt=""
      draggable={false}
