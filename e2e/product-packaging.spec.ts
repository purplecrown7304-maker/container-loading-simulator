...
test('enterprise product and box catalogs preserve handling constraints when imported from Excel', async ({ page }) => {
  ...
  await expect(refreshed.getByText('EX-01', { exact: false })).toBeVisible();
